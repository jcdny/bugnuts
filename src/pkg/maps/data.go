...
func init() {
	MapRoot = os.Getenv("HOME") + "/bot/src/pkg/maps/testdata/finals"
	m, err := ioutil.ReadDir(MapRoot)
	if err == nil {
		for _, f := range m {
			if strings.HasSuffix(f.Name, ".map") && f.Name != ".map" {
...
var MapSym = map[string]MapSymData{
	"cell_maze_p02_18":   MapSymData{2, 2, 2, "MirrR", 1, 74, 130, Point{0, 0}, -1, -1, 0, -1, Point{0, 0}},
	"cell_maze_p02_20":   MapSymData{2, 2, 0, "Trans", 2, 50, 70, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p02_21":   MapSymData{2, 2, 4, "R_180", 1, 76, 122, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p02_22":   MapSymData{2, 2, 4, "R_180", 1, 30, 142, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p03_21":   MapSymData{3, 3, 0, "Trans", 1, 42, 189, Point{14, -63}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p03_22":   MapSymData{3, 3, 0, "Trans", 3, 69, 30, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p03_23":   MapSymData{3, 3, 0, "Trans", 1, 42, 144, Point{14, -48}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p03_24":   MapSymData{3, 3, 0, "Trans", 3, 42, 57, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p03_25":   MapSymData{3, 3, 0, "Trans", 1, 33, 120, Point{11, -40}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p03_26":   MapSymData{3, 3, 0, "Trans", 1, 48, 72, Point{16, -24}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p04_21":   MapSymData{4, 4, 0, "Trans", 2, 34, 200, Point{17, 100}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p04_22":   MapSymData{4, 4, 4, "R_180", 2, 124, 76, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p04_23":   MapSymData{4, 4, 0, "Trans", 4, 84, 50, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p04_24":   MapSymData{4, 4, 4, "R_180", 2, 68, 98, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p04_25":   MapSymData{4, 4, 0, "Trans", 1, 56, 200, Point{14, -50}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_21":   MapSymData{5, 5, 0, "Trans", 1, 90, 150, Point{36, 30}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_22":   MapSymData{5, 5, 0, "Trans", 1, 105, 200, Point{21, 40}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_23":   MapSymData{5, 5, 0, "Trans", 1, 75, 120, Point{30, -24}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_24":   MapSymData{5, 5, 0, "Trans", 1, 140, 160, Point{28, 32}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_25":   MapSymData{5, 5, 0, "Trans", 1, 95, 115, Point{19, 23}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_26":   MapSymData{5, 5, 0, "Trans", 1, 55, 170, Point{11, 34}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_27":   MapSymData{5, 5, 0, "Trans", 1, 115, 200, Point{23, -40}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_28":   MapSymData{5, 5, 0, "Trans", 1, 90, 105, Point{36, -21}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_29":   MapSymData{5, 5, 0, "Trans", 1, 100, 200, Point{20, 40}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_30":   MapSymData{5, 5, 0, "Trans", 1, 140, 145, Point{28, 29}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_31":   MapSymData{5, 5, 0, "Trans", 1, 45, 170, Point{9, 34}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p05_32":   MapSymData{5, 5, 0, "Trans", 1, 110, 195, Point{22, 39}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p06_19":   MapSymData{6, 6, 4, "R_180", 3, 96, 42, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p06_20":   MapSymData{6, 6, 4, "R_180", 3, 120, 66, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p06_21":   MapSymData{6, 6, 4, "R_180", 3, 102, 66, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p06_22":   MapSymData{6, 6, 0, "Trans", 3, 54, 66, Point{27, 33}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p06_23":   MapSymData{6, 6, 0, "Trans", 2, 78, 66, Point{26, 22}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p06_24":   MapSymData{6, 6, 2, "MirrR", 3, 102, 66, Point{0, 0}, -1, -1, 0, -1, Point{0, 0}},
	"cell_maze_p07_13":   MapSymData{7, 7, 0, "Trans", 1, 77, 105, Point{11, 30}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p07_14":   MapSymData{7, 7, 0, "Trans", 1, 77, 196, Point{22, 28}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p07_15":   MapSymData{7, 7, 0, "Trans", 1, 112, 196, Point{32, 28}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p07_16":   MapSymData{7, 7, 0, "Trans", 1, 119, 147, Point{17, -42}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p07_17":   MapSymData{7, 7, 0, "Trans", 1, 77, 168, Point{22, 24}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p07_18":   MapSymData{7, 7, 0, "Trans", 1, 91, 154, Point{26, 22}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p08_09":   MapSymData{8, 8, 0, "Trans", 4, 88, 36, Point{44, 18}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p08_10":   MapSymData{8, 8, 4, "R_180", 4, 56, 50, Point{0, 0}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p08_11":   MapSymData{8, 8, 0, "Trans", 4, 80, 50, Point{40, 25}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p08_12":   MapSymData{8, 8, 0, "Trans", 2, 52, 120, Point{13, -30}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p09_04":   MapSymData{9, 9, 0, "Trans", 1, 81, 198, Point{18, -22}, -1, -1, -1, -1, Point{0, 0}},
	"cell_maze_p09_05":   MapSymData{9, 9, 0, "Trans", 1, 108, 198, Point{24, -22}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p02_34":        MapSymData{2, 2, 2, "MirrR", 1, 108, 138, Point{0, 0}, -1, -1, 27, -1, Point{0, 0}},
	"maze_p02_35":        MapSymData{2, 2, 2, "MirrR", 1, 72, 136, Point{0, 0}, -1, -1, 29, -1, Point{0, 0}},
	"maze_p02_36":        MapSymData{2, 2, 2, "MirrR", 1, 96, 120, Point{0, 0}, -1, -1, 9, -1, Point{0, 0}},
	"maze_p02_37":        MapSymData{2, 2, 6, "NDiag", 1, 66, 66, Point{0, 0}, 13, -1, -1, -1, Point{0, 0}},
	"maze_p02_38":        MapSymData{2, 2, 2, "MirrR", 1, 72, 88, Point{0, 0}, -1, -1, 14, -1, Point{0, 0}},
	"maze_p02_39":        MapSymData{2, 2, 7, "PDiag", 1, 84, 84, Point{0, 0}, -1, 79, -1, -1, Point{0, 0}},
	"maze_p02_40":        MapSymData{2, 2, 6, "NDiag", 1, 120, 120, Point{0, 0}, 86, -1, -1, -1, Point{0, 0}},
	"maze_p02_41":        MapSymData{2, 2, 6, "NDiag", 1, 84, 84, Point{0, 0}, 25, -1, -1, -1, Point{0, 0}},
	"maze_p02_42":        MapSymData{2, 2, 2, "MirrR", 1, 72, 126, Point{0, 0}, -1, -1, 34, -1, Point{0, 0}},
	"maze_p02_43":        MapSymData{2, 2, 7, "PDiag", 1, 128, 128, Point{0, 0}, -1, 26, -1, -1, Point{0, 0}},
	"maze_p03_05":        MapSymData{3, 3, 0, "Trans", 1, 72, 72, Point{24, 24}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p04_38":        MapSymData{4, 4, 10, "DBoth", 1, 120, 120, Point{0, 0}, 50, 21, -1, -1, Point{0, 0}},
	"maze_p04_42":        MapSymData{4, 4, 3, "Rotat", 1, 104, 104, Point{0, 0}, -1, -1, -1, -1, Point{31, 79}},
	"maze_p04_44":        MapSymData{4, 4, 10, "DBoth", 1, 104, 104, Point{0, 0}, 92, 79, -1, -1, Point{0, 0}},
	"maze_p04_45":        MapSymData{4, 4, 3, "Rotat", 1, 80, 80, Point{0, 0}, -1, -1, -1, -1, Point{13, 31}},
	"maze_p04_48":        MapSymData{4, 4, 0, "Trans", 1, 96, 96, Point{24, -24}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p04_49":        MapSymData{4, 4, 10, "DBoth", 1, 102, 102, Point{0, 0}, 23, 86, -1, -1, Point{0, 0}},
	"maze_p04_50":        MapSymData{4, 4, 3, "Rotat", 1, 96, 96, Point{0, 0}, -1, -1, -1, -1, Point{1, 82}},
	"maze_p04_51":        MapSymData{4, 4, 10, "DBoth", 1, 128, 128, Point{0, 0}, 63, 26, -1, -1, Point{0, 0}},
	"maze_p04_52":        MapSymData{4, 4, 3, "Rotat", 1, 108, 108, Point{0, 0}, -1, -1, -1, -1, Point{7, 52}},
	"maze_p04_53":        MapSymData{4, 4, 10, "DBoth", 1, 80, 80, Point{0, 0}, 14, 47, -1, -1, Point{0, 0}},
	"maze_p04_54":        MapSymData{4, 4, 3, "Rotat", 1, 96, 96, Point{0, 0}, -1, -1, -1, -1, Point{39, 43}},
	"maze_p04_56":        MapSymData{4, 4, 0, "Trans", 1, 96, 96, Point{24, 24}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p05_05":        MapSymData{5, 5, 0, "Trans", 1, 150, 150, Point{30, -60}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p05_06":        MapSymData{5, 5, 0, "Trans", 1, 120, 150, Point{48, 30}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p06_05":        MapSymData{6, 6, 0, "Trans", 1, 144, 144, Point{24, 24}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p07_05":        MapSymData{7, 7, 0, "Trans", 1, 112, 112, Point{16, 16}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p07_06":        MapSymData{7, 7, 0, "Trans", 1, 84, 84, Point{12, -12}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p07_07":        MapSymData{7, 7, 0, "Trans", 1, 84, 126, Point{12, -36}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p07_08":        MapSymData{7, 7, 0, "Trans", 1, 84, 126, Point{12, 18}, -1, -1, -1, -1, Point{0, 0}},
	"maze_p08_11":        MapSymData{8, 8, 0, "Trans", 1, 128, 128, Point{16, -48}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_47": MapSymData{2, 2, 0, "Trans", 1, 100, 80, Point{50, 40}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_48": MapSymData{2, 2, 0, "Trans", 1, 80, 96, Point{40, 48}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_49": MapSymData{2, 2, 0, "Trans", 1, 84, 86, Point{42, 43}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_50": MapSymData{2, 2, 0, "Trans", 1, 54, 88, Point{27, 44}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_51": MapSymData{2, 2, 0, "Trans", 1, 56, 88, Point{28, 44}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_52": MapSymData{2, 2, 0, "Trans", 1, 86, 68, Point{43, 34}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_53": MapSymData{2, 2, 0, "Trans", 1, 90, 72, Point{45, 36}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_54": MapSymData{2, 2, 0, "Trans", 1, 52, 52, Point{26, 26}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_55": MapSymData{2, 2, 0, "Trans", 1, 58, 94, Point{29, 47}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_56": MapSymData{2, 2, 0, "Trans", 1, 78, 96, Point{39, 48}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_57": MapSymData{2, 2, 0, "Trans", 1, 62, 96, Point{31, 48}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_58": MapSymData{2, 2, 0, "Trans", 1, 88, 90, Point{44, 45}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_59": MapSymData{2, 2, 0, "Trans", 1, 84, 68, Point{42, 34}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_60": MapSymData{2, 2, 0, "Trans", 1, 60, 50, Point{30, 25}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_61": MapSymData{2, 2, 0, "Trans", 1, 96, 84, Point{48, 42}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_62": MapSymData{2, 2, 0, "Trans", 1, 88, 80, Point{44, 40}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_63": MapSymData{2, 2, 0, "Trans", 1, 100, 86, Point{50, 43}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_64": MapSymData{2, 2, 0, "Trans", 1, 68, 82, Point{34, 41}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_65": MapSymData{2, 2, 0, "Trans", 1, 90, 76, Point{45, 38}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_66": MapSymData{2, 2, 0, "Trans", 1, 70, 82, Point{35, 41}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_67": MapSymData{2, 2, 0, "Trans", 1, 78, 74, Point{39, 37}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_68": MapSymData{2, 2, 0, "Trans", 1, 88, 74, Point{44, 37}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_69": MapSymData{2, 2, 0, "Trans", 1, 70, 74, Point{35, 37}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_70": MapSymData{2, 2, 0, "Trans", 1, 88, 98, Point{44, 49}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_71": MapSymData{2, 2, 0, "Trans", 1, 74, 78, Point{37, 39}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p02_72": MapSymData{2, 2, 0, "Trans", 1, 50, 56, Point{25, 28}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_19": MapSymData{3, 3, 0, "Trans", 1, 102, 126, Point{34, 42}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_20": MapSymData{3, 3, 0, "Trans", 1, 63, 123, Point{21, 41}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_21": MapSymData{3, 3, 0, "Trans", 1, 54, 81, Point{18, 27}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_22": MapSymData{3, 3, 0, "Trans", 1, 138, 132, Point{46, 44}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_23": MapSymData{3, 3, 0, "Trans", 1, 135, 120, Point{45, -40}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_24": MapSymData{3, 3, 0, "Trans", 1, 78, 72, Point{26, -24}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_25": MapSymData{3, 3, 0, "Trans", 1, 147, 117, Point{49, -39}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_26": MapSymData{3, 3, 0, "Trans", 1, 144, 141, Point{48, -47}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_27": MapSymData{3, 3, 0, "Trans", 1, 120, 150, Point{40, 50}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_28": MapSymData{3, 3, 0, "Trans", 1, 81, 117, Point{27, -39}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_29": MapSymData{3, 3, 0, "Trans", 1, 99, 141, Point{33, -47}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_30": MapSymData{3, 3, 0, "Trans", 1, 75, 111, Point{25, 37}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p03_31": MapSymData{3, 3, 0, "Trans", 1, 114, 147, Point{38, 49}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p04_09": MapSymData{4, 4, 0, "Trans", 1, 144, 116, Point{36, 29}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p04_10": MapSymData{4, 4, 0, "Trans", 1, 68, 120, Point{17, -30}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p05_06": MapSymData{5, 5, 0, "Trans", 1, 120, 150, Point{48, 30}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p05_07": MapSymData{5, 5, 0, "Trans", 1, 115, 120, Point{23, -24}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p05_08": MapSymData{5, 5, 0, "Trans", 1, 105, 130, Point{42, -26}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p06_06": MapSymData{6, 6, 0, "Trans", 1, 150, 144, Point{25, 24}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p06_07": MapSymData{6, 6, 0, "Trans", 1, 150, 144, Point{25, 24}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p07_03": MapSymData{7, 7, 0, "Trans", 1, 119, 119, Point{34, 17}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p09_01": MapSymData{9, 9, 0, "Trans", 1, 144, 144, Point{32, 16}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p10_03": MapSymData{10, 10, 0, "Trans", 1, 140, 140, Point{14, -42}, -1, -1, -1, -1, Point{0, 0}},
	"random_walk_p10_04": MapSymData{10, 10, 0, "Trans", 1, 110, 140, Point{33, 14}, -1, -1, -1, -1, Point{0, 0}},
}

// The maps from the development phase
var MapSymDev = map[string]MapSymData{
